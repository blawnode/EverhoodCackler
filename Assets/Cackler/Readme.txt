...
// This file was auto-generated by uMod Build Engine 2.0 for 'Cackler'

#Requirements

The requirements for 'Cackler' are as follows:
	
	uMod version: 2.7.6 or newer
	Unity version: 2018.4.27f1

#Content

The content types fhat can be included for '%Cackler' are as follows:

	Scene mods: No
	Prefab mods: Yes
	Script mods: Yes

The parent folder of this file called 'Cackler' is known as the 'Mod Folder' and this is where all mod content should be placed in order for it to be exported. 
